...
namespace ClipThief.Ui
{
    public static class Constants
    {
        public static class StartsWith
        {
            ...
            {
                public static IEnumerable<bool> False = new[] { false }.ToArray();

                public static IEnumerable<bool> True = new[] { true }.ToArray();
            }

            public static class Unit
            {
                public static IEnumerable<System.Reactive.Unit> Default =
                    new[] { System.Reactive.Unit.Default }.ToArray();
